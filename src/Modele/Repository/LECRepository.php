...
class LECRepository extends RepositoryMere
{
    ...
    {
        $sql = "SELECT * from joueurs where Dle = 'LEC' AND active = 1";
...
//    public static function recupererFromNom($nom)
//    {
...
//    {
//        $sql = "SELECT * from joueurs WHERE nom LIKE :l AND dle = 'LEC' AND active = 1 ORDER BY nom; ";
//
